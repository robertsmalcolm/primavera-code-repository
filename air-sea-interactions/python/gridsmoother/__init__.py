...
__date__ = '$Date: 2016-02-16 15:15:55 +0000 (Tue, 16 Feb 2016) $ '
__rev__ = "$Rev: 12490 $ "
__author__ = "$Author: hadmm $ "
__HeadURL__ = "$HeadURL: svn://fcm9/utils_svn/MatthewMizielinski/trunk/python/gridsmoother/__init__.py $ "
__id__ = "$Id: __init__.py 12490 2016-02-16 15:15:55Z hadmm $ "
__lastrev__ = "$LastChangedRevision: 12490 $ "
...
class GridSmoother(object):
    ...
    def smooth_3d_cube(self, cube, gridpoint_atol=1e-3, masked = True):
        ...
        * gridpoint_atol:
        ...
        for cslice in cube.slices(['latitude','longitude']):
            smoothed_slices.append(self.smooth_2d_cube(cslice, gridpoint_atol, reweight = masked))
